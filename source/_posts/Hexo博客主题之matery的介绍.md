---
title: Hexo博客主题之matery介绍
date: 2026-05-20 14:34:00
author: Awesone
img: 
top: false
cover: true
...
- matery
---
[English Document](README.md) | [演示示例](https://personyzh.cn/)
...
点击 [这里](https://github.com/awesome-svg/hexo-theme-matery) 下载 `master` 分支的最新稳定版的代码，解压缩后，将 `hexo-theme-matery` 的文件夹复制到你 Hexo 的 `themes` 文件夹中即可。
...
```html
<a href="https://github.com/awesome-svg" class="tooltipped" target="_blank" data-tooltip="访问我的GitHub" data-position="top" data-delay="50">
